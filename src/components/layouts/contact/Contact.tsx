...
export const Contact = () => {
  ...
  return (
    <section
      className="py-20 pt-8 relative bg-gradient-to-b from-black via-[#121212] to-black"
      id="contact"
    >
      <div className="flex flex-col lg:flex-row items-center justify-evenly gap-y-10 md:gap-x-10">
        {/* Título */}
        ...
        <Reveal
          ...
          className="md:max-w-[600px] w-[90%] bg-[#121212] z-10"
        >
          <div className="bg-[#121212] py-12 px-6 rounded-xl shadow-sm shadow-primary-gray ">
            <Form t={t} />
          </div>
        </Reveal>
      </div>
